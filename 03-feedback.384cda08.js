...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),l=document.querySelector("input[name=email]"),u=document.querySelector("textarea[name=message]"),r="feedback-form-state",n=JSON.parse(localStorage.getItem(r));function o(){let e=c(l.value,u.value);localStorage.setItem(r,JSON.stringify(e))}function c(e,t){return{email:e,message:t}}function s(e){e.preventDefault(),console.log(c(l.value,u.value)),l.value="",u.value="",localStorage.clear()}n&&(l.value=n.email,u.value=n.message),a.addEventListener("input",(0,e.default)(o,500)),a.addEventListener("submit",s);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-8/03-feedback.384cda08.js.map